  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Citation - Transforming your thoughts into text and images, creating memorable quotes with ease and style."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1623245428091-9c13920b8deb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaXRhdGlvbnN8ZW58MHx8fHwxNjkwMDQyMTMyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@gatienbataille?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Gatien Bataille`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Citation - Transforming your thoughts into text and images, creating memorable quotes with ease and style.`}
            </Text>
            <Box
